...
save(savefile,'drop_num','sub_drop_num','ISD','R', ...
    ...
    'Shadow_std_V2I','Shadow_std_V2V_LOS','Shadow_std_V2V_NLOS','D_corr_V2I','D_corr_V2V','R_matrix');
...
%        Distance_VUE2VUE_DELTA=Distance_VUE2VUE-Distance_VUE2VUE_0;
    ...
    %% save data
    savefile = sprintf('../Data/data_deploy/node_deployment_Freeway_vehicle_speed=%d_No%d_subdrop_ID%d.mat',vehicle_speed,real_snapshot,sub_snapshot);
